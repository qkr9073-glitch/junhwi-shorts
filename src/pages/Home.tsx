    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      <div className="text-center mb-8 sm:mb-10">
        ...
        <p className="mt-4 text-[15px] sm:text-base text-ink-muted max-w-lg mx-auto leading-relaxed">
          샤오홍슈 · 더우인 바로가기, 로그인 가이드, 영상 다운로더까지.
          <br />
          한 페이지에서 중국 쇼츠 리서치를 시작하세요.
        </p>
      </div>

      <div className="mb-8 rounded-3xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-yellow-50 p-5 sm:p-6 shadow-sm">
      ...
      <div className="mb-5 text-[11px] font-bold tracking-wider text-ink-soft uppercase">
        1. 플랫폼 바로가기
      </div>
        ...
        <div className="rounded-[calc(1.5rem-2px)] bg-white p-5 sm:p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[13px] text-ink-muted mt-1">
                URL 하나로 워터마크 없는 샤오홍슈 영상을 내려받아보세요.
              </p>
            </div>
      ...
      >
        <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-300 blur-lg opacity-50 group-hover:opacity-90 animate-pulse" />
        <div className="relative rounded-3xl bg-gradient-to-br from-[#FEE500] via-[#FFD900] to-[#FEE500] p-5 sm:p-6 shadow-[0_12px_40px_rgba(254,229,0,0.5)] ring-2 ring-yellow-400">
          <div className="flex items-center gap-4">
            <div className="shrink-0 w-14 h-14 rounded-2xl bg-[#3C1E1E] flex items-center justify-center text-3xl shadow-inner">
              💬
            </div>
            <div className="flex-1 min-w-0 text-left">
              <div className="text-[11px] font-bold text-[#3C1E1E]/70 mb-0.5 tracking-wide">
                🔥 쇼츠 크리에이터라면 필수!
              </div>
            ...
            <div className="shrink-0 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-[#3C1E1E] text-[#FEE500] text-xs sm:text-sm font-bold whitespace-nowrap group-hover:bg-black transition shadow-md">
              무료 입장 →
            </div>
          </div>
        </div>
